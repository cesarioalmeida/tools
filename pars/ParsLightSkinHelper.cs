...
namespace Syncfusion.Themes.ParsLight.WPF
{
    /// <exclude/>
    public class ParsLightSkinHelper : SkinHelper
    {
        ...
        {
            string rootStylePath = "/Syncfusion.Themes.ParsLight.WPF;component/";
    ...
    /// </summary>
    public class ParsLightThemeSettings: IThemeSetting
    {
        /// <summary>
        /// Constructor to create an instance of ParsLightThemeSettings.
        /// </summary>
        public ParsLightThemeSettings()
        {
        ...
        /// <code language="C#">
        /// <![CDATA[
        /// ParsLightThemeSettings themeSettings = new ParsLightThemeSettings();
		/// themeSettings.Palette = Windows11Palette.PurpleShadowDark;
        /// SfSkinManager.RegisterThemeSettings("ParsLight", themeSettings);
        /// ]]>
        /// </code>
        /// </example>
        /// <remarks>
		...
		/// <code language="C#">
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.HeaderFontSize = 16;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.SubHeaderFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.TitleFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.SubTitleFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.BodyFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.Body AltFontSize = 10;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.FontFamily = new FontFamily("Callibri");
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.PrimaryBackground = Brushes.Red;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// ParsLightThemeSettings parsLightThemeSettings = new ParsLightThemeSettings();
		/// parsLightThemeSettings.PrimaryForeground = Brushes.AntiqueWhite;
		/// SfSkinManager.RegisterThemeSettings("ParsLight", parsLightThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
